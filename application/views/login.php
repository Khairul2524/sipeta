...
<body>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">SIP Covid</span>
                                </a>
                            </div><!-- End Logo -->
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="<?= site_url('auth/login') ?>" method="POST">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <div class="invalid-feedback">Silahkan Masukka Username Anda !.</div>
                                            </div>
                                        </div>
    ...
    <!-- Vendor JS Files -->
    <script src="<?= base_url('assets/backand/') ?>assets/vendor/apexcharts/apexcharts.min.js"></script>
    <script src="<?= base_url('assets/backand/') ?>vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?= base_url('assets/backand/') ?>vendor/chart.js/chart.min.js"></script>
    <script src="<?= base_url('assets/backand/') ?>vendor/echarts/echarts.min.js"></script>
    <script src="<?= base_url('assets/backand/') ?>vendor/quill/quill.min.js"></script>
    <script src="<?= base_url('assets/backand/') ?>vendor/simple-datatables/simple-datatables.js"></script>
    <script src="<?= base_url('assets/backand/') ?>vendor/tinymce/tinymce.min.js"></script>
    <script src="<?= base_url('assets/backand/') ?>vendor/php-email-form/validate.js"></script>

    <!-- Template Main JS File -->
    <script src="<?= base_url('assets/backand/') ?>js/main.js"></script>
